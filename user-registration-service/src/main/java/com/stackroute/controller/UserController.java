...
public class UserController {
	...
	@Autowired
	public UserController(IUserService userService,KafkaTemplate kafkaTemplate,JsonUtil jsonUtil) {
	...
	public ResponseEntity<String> registerUser(@RequestBody @Valid UserDto userDto) {
		...
		String message = jsonUtil.toJson(usermq);
